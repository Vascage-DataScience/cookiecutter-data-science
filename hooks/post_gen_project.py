...
username = input("Please type in your username for minio-s3 storage: ")
password = getpass.getpass("Please type in your password for minio-s3 storage: ")
...
for generated_path in Path("app").iterdir():
